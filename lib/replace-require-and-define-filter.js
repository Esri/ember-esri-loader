...
module.exports = class ReplaceRequireAndDefine extends Filter {
  ...
  processString(code) {
    // TODO: update replaceRequireAndDefine so externalAmdModulesForFile is optional
    const externalAmdModulesForFile = new Set();
    return replaceRequireAndDefine(code, this.amdPackages, externalAmdModulesForFile);
  }
}